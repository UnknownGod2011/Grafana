...
class OperatorConsoleTests(unittest.TestCase):
    ...
    def test_console_has_fail_closed_checkpoint_recovery_workflow(self):
        ...
        self.assertIn("lifecycleBlocked()||diagnosisUnavailable()||!approval", js)
    ...
    def test_evidence_unavailable_state_is_explicit_sanitized_and_fail_closed(self):
        ...
        self.assertIn("q('briefing').disabled=lifecycleBlocked()||diagnosisUnavailable()", js)
        self.assertIn("q('approval-revision').disabled=lifecycleBlocked()||diagnosisUnavailable()", js)
        self.assertIn("lifecycleBlocked()||diagnosisUnavailable()||!approval", js)
