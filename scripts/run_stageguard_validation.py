...
SENSITIVE_ENV_SUFFIXES=("_TOKEN","_API_KEY","_PASSWORD","_SECRET","_ACCESS_KEY","_PRIVATE_KEY","_CLIENT_SECRET")
VALIDATION_ENV_OVERRIDES={"PYTHONNOUSERSITE":"1","PYTHONDONTWRITEBYTECODE":"1","GCE_METADATA_HOST":"127.0.0.1:9","GCE_METADATA_IP":"127.0.0.1","AWS_EC2_METADATA_DISABLED":"true","NO_PROXY":"localhost,127.0.0.1,::1"}
