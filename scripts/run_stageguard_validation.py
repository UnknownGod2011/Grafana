...
SENSITIVE_ENV_PREFIXES=("GRAFANA_","GEMINI_","GOOGLE_API_","STAGEGUARD_REMEDIATION_","AWS_","AZURE_","ANTHROPIC_","OPENAI_","GITHUB_","GH_","HF_","HUGGINGFACE_","GIT_","DYLD_","BASH_FUNC_")
