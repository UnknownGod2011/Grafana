...
# Package-manager/client config channels are included because they can contain authenticated
# registries or credential files even when no literal secret is present in the environment.
