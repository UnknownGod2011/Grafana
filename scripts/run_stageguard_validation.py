...
SENSITIVE_ENV_NAMES=frozenset({"GOOGLE_APPLICATION_CREDENTIALS","GOOGLE_CREDENTIALS","GOOGLE_CLOUD_KEYFILE_JSON","CLOUDSDK_AUTH_ACCESS_TOKEN","CLOUDSDK_AUTH_CREDENTIAL_FILE_OVERRIDE","CLOUDSDK_CONFIG","GCE_METADATA_HOST","GCE_METADATA_IP","HTTP_PROXY","HTTPS_PROXY","ALL_PROXY","NO_PROXY","PYTHONHOME","PYTHONPATH","PYTHONSTARTUP","PYTHONINSPECT","PYTHONBREAKPOINT","SSH_AUTH_SOCK","SSH_AGENT_PID","GIT_ASKPASS","SSH_ASKPASS","GIT_SSH","GIT_SSH_COMMAND","NETRC","DOCKER_CONFIG","KUBECONFIG","PIP_INDEX_URL","PIP_EXTRA_INDEX_URL","PIP_CONFIG_FILE","NPM_CONFIG_USERCONFIG","YARN_RC_FILENAME","CURL_HOME","WGETRC","XDG_CONFIG_HOME","XDG_DATA_HOME","APPDATA","LOCALAPPDATA"})
