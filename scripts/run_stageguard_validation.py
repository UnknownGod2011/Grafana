...
SENSITIVE_ENV_NAMES=frozenset({"GOOGLE_APPLICATION_CREDENTIALS","GOOGLE_CREDENTIALS","GOOGLE_CLOUD_KEYFILE_JSON","CLOUDSDK_AUTH_ACCESS_TOKEN","CLOUDSDK_AUTH_CREDENTIAL_FILE_OVERRIDE","CLOUDSDK_CONFIG","GCE_METADATA_HOST","GCE_METADATA_IP","HOME","USERPROFILE","TMPDIR","TMP","TEMP","HTTP_PROXY","HTTPS_PROXY","ALL_PROXY","NO_PROXY","PYTHONHOME","PYTHONPATH","PYTHONSTARTUP","PYTHONINSPECT","PYTHONBREAKPOINT","PYTHONWARNINGS","PYTHONUSERBASE","PYTHONPYCACHEPREFIX","PYTHONEXECUTABLE","SSH_AUTH_SOCK","SSH_AGENT_PID","GIT_ASKPASS","SSH_ASKPASS","GIT_SSH","GIT_SSH_COMMAND","GIT_EXEC_PATH","GIT_EXTERNAL_DIFF","GIT_DIFF_OPTS","GIT_EDITOR","GIT_SEQUENCE_EDITOR","GIT_TEMPLATE_DIR","GIT_PAGER","PAGER","MANPAGER","SYSTEMD_PAGER","EDITOR","VISUAL","LESSOPEN","LESSCLOSE","NETRC","DOCKER_CONFIG","KUBECONFIG","PIP_INDEX_URL","PIP_EXTRA_INDEX_URL","PIP_CONFIG_FILE","NPM_CONFIG_USERCONFIG","YARN_RC_FILENAME","CURL_HOME","WGETRC","XDG_CONFIG_HOME","XDG_DATA_HOME","APPDATA","LOCALAPPDATA","SSLKEYLOGFILE","SSL_CERT_FILE","SSL_CERT_DIR","REQUESTS_CA_BUNDLE","CURL_CA_BUNDLE","LD_PRELOAD","LD_LIBRARY_PATH","GCONV_PATH","LOCPATH","NLSPATH","BASH_ENV","BASHOPTS","SHELLOPTS","CDPATH","ENV","ZDOTDIR","NODE_OPTIONS","NODE_PATH","RUBYOPT","RUBYLIB","PERL5OPT","PERL5LIB","JAVA_TOOL_OPTIONS","JDK_JAVA_OPTIONS","CLASSPATH","MAVEN_OPTS","MAVEN_ARGS","MAVEN_USER_HOME","GRADLE_OPTS","GRADLE_USER_HOME","DOTNET_STARTUP_HOOKS","DOTNET_ADDITIONAL_DEPS","DOTNET_SHARED_STORE","CORECLR_PROFILER","CORECLR_PROFILER_PATH","CORECLR_ENABLE_PROFILING","GOENV","GOFLAGS","GOTOOLCHAIN","GOWORK","CARGO_HOME","RUSTC_WRAPPER","RUSTC_WORKSPACE_WRAPPER","RUSTFLAGS","RUSTDOCFLAGS","MAKEFLAGS","MFLAGS","MAKEFILES"})
SENSITIVE_ENV_PREFIXES=("GRAFANA_","GEMINI_","GOOGLE_API_","STAGEGUARD_REMEDIATION_","AWS_","AZURE_","ANTHROPIC_","OPENAI_","GITHUB_","GH_","HF_","HUGGINGFACE_","GIT_CONFIG_","GIT_ATTR_","DYLD_","BASH_FUNC_")
...
VALIDATION_ENV_OVERRIDES={"PYTHONNOUSERSITE":"1","PYTHONDONTWRITEBYTECODE":"1","GCE_METADATA_HOST":"127.0.0.1:9","GCE_METADATA_IP":"127.0.0.1","AWS_EC2_METADATA_DISABLED":"true","NO_PROXY":"localhost,127.0.0.1,::1","GIT_CONFIG_NOSYSTEM":"1","GIT_ATTR_NOSYSTEM":"1","GIT_TERMINAL_PROMPT":"0","GIT_PAGER":"cat","PAGER":"cat","SYSTEMD_PAGER":"cat","PIP_NO_INPUT":"1"}
