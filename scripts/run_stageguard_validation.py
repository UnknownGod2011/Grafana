...
SENSITIVE_ENV_PREFIXES=("GRAFANA_","GEMINI_","GOOGLE_API_","STAGEGUARD_REMEDIATION_","AWS_","AZURE_","ANTHROPIC_","OPENAI_","GITHUB_","GH_","HF_","HUGGINGFACE_","GIT_CONFIG_","DYLD_","BASH_FUNC_")
...
VALIDATION_ENV_OVERRIDES={"PYTHONNOUSERSITE":"1","PYTHONDONTWRITEBYTECODE":"1","GCE_METADATA_HOST":"127.0.0.1:9","GCE_METADATA_IP":"127.0.0.1","AWS_EC2_METADATA_DISABLED":"true","NO_PROXY":"localhost,127.0.0.1,::1","GIT_CONFIG_NOSYSTEM":"1","GIT_TERMINAL_PROMPT":"0","GIT_PAGER":"cat","PAGER":"cat","SYSTEMD_PAGER":"cat","PIP_NO_INPUT":"1"}
