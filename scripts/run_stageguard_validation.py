...
VALIDATION_ENV_OVERRIDES={"PYTHONNOUSERSITE":"1","PYTHONDONTWRITEBYTECODE":"1","GCE_METADATA_HOST":"127.0.0.1:9","GCE_METADATA_IP":"127.0.0.1","AWS_EC2_METADATA_DISABLED":"true","NO_PROXY":"localhost,127.0.0.1,::1","GIT_TERMINAL_PROMPT":"0"}
...
GATES=(
 ...
 Gate("evidence and diagnosis",("test_telemetry.py","test_log_activation.py","test_log_evidence.py","test_investigator.py","test_correlated_investigator.py","test_briefing_runtime.py","test_gemini_commander.py","test_gemini_acceptance_smoke.py")),
 ...
 Gate("incident lifecycle",("test_anchored_incident_runtime.py","test_*evidence_unavailable*.py","test_*recovery_recheck.py","test_recovery_recheck_restart.py","test_*transition_failure_authority.py","test_transition_failure_snapshot_authority.py")),
